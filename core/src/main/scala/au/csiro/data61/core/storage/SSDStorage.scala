...
object SSDStorage extends Storage[SsdID, SemanticSourceDesc] {
  ...
  override def add(id: SsdID, ssd: SemanticSourceDesc): Option[SsdID] = {
    ...
    ssd.isComplete match {
      case true =>
        // adding ssd to factory
        super.add(id, ssd)
        // TODO: trigger update to the ontology layer!!!
        // TODO: Karma update -- ontologyManager.doImport(f, "UTF-8"); ontologyManager.updateCache();
        // TODO: trigger update for the alignment graph!!!
      case false =>
        logger.info(s"Semantic Source Desc $id is not consistent.")
        None
    }
  }
