...
class FeatureExtractorSpec extends mutable.Specification {
    ...
    //         NumUniqueValuesFeatureExtractor().computeFeature(PreprocessedAttribute(attr, Map())) mustEqual List(3)
    //     }
    // }
    ...
    //         extractor.computeFeature(PreprocessedAttribute(attr1,Map())) mustEqual List(0.2)

    //         val attr2 = Attribute("testAttr", None, List("","foba0","o9baz","a8sdf"),Some(dummyParent))
    //         extractor.computeFeature(PreprocessedAttribute(attr2,Map())) mustEqual List(0.15000000000000002)

    //         val attr3 = Attribute("testAttr", None, List("","","",""),Some(dummyParent))
    //         extractor.computeFeature(PreprocessedAttribute(attr3,Map())) mustEqual List(0)
    //     }
    // }
    ...
    //     "compute features" in {
    //         val attr1Contents = Source.fromInputStream(getClass.getClassLoader.getResourceAsStream("datasets/northix/db1/return_date@rental@1.dat")).getLines.toList
    //         val attr2Contents = Source.fromInputStream(getClass.getClassLoader.getResourceAsStream("datasets/northix/db2/UnitsOnOrder@products@2.txt")).getLines.toList
    ...
    //     "compute features" in {
    //         val attr1Contents = Source.fromInputStream(getClass.getClassLoader.getResourceAsStream("datasets/northix/db1/active@customer@1.dat")).getLines.toList
    //         val attr2Contents = Source.fromInputStream(getClass.getClassLoader.getResourceAsStream("datasets/northix/db2/EmployeeID@orders@2.txt")).getLines.toList
