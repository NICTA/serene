...
import org.specs2._
import com.nicta.dataint.ingestion.loader.NorthixDataLoader
import com.nicta.dataint.matcher.train._
import com.nicta.dataint.data.BasicLabels
import com.nicta.dataint.matcher.features._
import com.nicta.dataint.ingestion.loader._

import scala.collection.JavaConverters._

class TrainMLibSemanticTypeClassifierSpec extends mutable.Specification {
    s"""TrainMLibSemanticTypeClassifierSpec""" should {
        "train a model" in {
